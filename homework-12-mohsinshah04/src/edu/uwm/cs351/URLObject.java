 ...
 */
public class URLObject extends Resource implements Iterable<URL> {
	...
	/**
	 * Return a checksum of the content of this URL Object.
	 * @return checksum of the content pointed to by this URL
	 */
	...
	public Iterator<URL> iterator() {
		try {
			URL url = uri.toURL();
			return new URLHTMLReader(url,new BufferedInputStream(url.openStream()));
		} catch (IOException e) {
